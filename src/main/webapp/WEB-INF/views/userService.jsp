...
<body>
	...
	<h3>사용자 등록</h3>
		...
		<input type="text" id="snsId" name="snsId" placeholder="SNS아이디" /><br />
		<input type="text" id="snsType" name="snsType" placeholder="SNS종류" /><br />
	...
	<h3>사용자 로그인</h3>
		<input type="text" id="loginUserId" name="userId" placeholder="아이디" /><br />
